...
#define TX_LOCAL_NUM    20//18 // 总的大小
#define RX_LOCAL_NUM    32//30 // 16//28

#define CAL_TEST_TX     20//18//16 // 测试局部
#define CAL_TEST_RX     32//30//28 //16//28
...
#define CAL_ARAM_RX     32//30//28 //16//28
