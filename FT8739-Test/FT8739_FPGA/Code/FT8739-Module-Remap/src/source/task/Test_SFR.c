...
void Test_SFR()
{
    ...
    DBG_SFR("\n\r\n\rSPI0:");
    Test_WriteSFR(0xA3,0xC3,0x00);//SPI0CON2
    Test_WriteSFR(0xA5,0x8F,0x00);//SPI0CON3
    Test_WriteSFR(0xA6,0xC0,0x00);//SPI0CON4
    
    DBG_SFR("\n\r\n\rSPI1:");
    Test_WriteSFR(0xB3,0xFF,0x00);//SPI1CON
    Test_WriteSFR(0xB4,0xDF,0x00);//SPI1CON2
    //Test_WriteSFR(0xB5,0xFF,0x00);//SPIBUF
    Test_WriteSFR(0xB1,0xFE,0x00);//SPICON3
    Test_WriteSFR(0xB2,0xFF,0x00);//SPICON4
#if 0
    DBG_SFR("\n\r\n\rUart:");
    Test_WriteSFR(0xA9,0xB4,0x00);//UARTCON
    ...
    Test_WriteSFR(0x9E,0x0C,0x00);//RTCCON
    Test_WriteSFR(0x9F,0xFF,0x00);//RTCSLN     
    
    DBG_SFR("\n\nSystem:");
    Test_WriteSFR(0x98,0xFF,0x80);//SYS_CON
    ...
    Test_WriteSFR(0xE1,0x03,0x00);//DSVCON
    Test_WriteSFR(0xE2,0xCF,0x00);//DBGCON0
    Test_WriteSFR(0xE3,0xFF,0x00);//DBGCON1
    //Test_WriteSFR(0xF1,0xFF,0x00);//PORRST_CNT   RO 
    //Test_WriteSFR(0xF2,0xFF,0x00);//EXTRST_CNT   RO
    //Test_WriteSFR(0xF3,0xFF,0x00);//WDTRST_CNT   RO
    //Test_WriteSFR(0xF4,0xFF,0x00);//LCDRST_CNT   RO
    //Test_WriteSFR(0xF5,0xFF,0x00);//LVD_STA      RO
    ...
    DBG_SFR("\n\r\n\rCGU:");
    Test_WriteSFR(0xC1,0xFF,0x00);//CGUCON8
    Test_WriteSFR(0xC2,0xFF,0x00);//CGUCON9
    Test_WriteSFR(0xC3,0xFF,0x00);//CGUCONA
    Test_WriteSFR(0xC4,0xFF,0x00);//CGUCONB
    Test_WriteSFR(0xC5,0xFF,0x00);//CGUCONC
    Test_WriteSFR(0xC6,0xFF,0x00);//CGUCOND
    Test_WriteSFR(0xC7,0xFF,0x00);//CGUCONE    
    Test_WriteSFR(0xC8,0xFF,0x00);//CGUCON1
    Test_WriteCGU0(0xC9,0x3E,0x24);//CGUCON0 
    //Test_WriteSFR(0xC9,0x3E,0x24);//CGUCON0    
    Test_WriteSFR(0xCA,0xFF,0x00);//CGUCON2
    Test_WriteSFR(0xCB,0xFF,0x00);//CGUCON3
    Test_WriteSFR(0xCC,0xC3,0x01);//CGUCON4
    Test_WriteSFR(0xCD,0xFF,0x00);//CGUCON5
    Test_WriteSFR(0xCE,0xE0,0x00);//CGUCON6
    Test_WriteSFR(0xCF,0x3F,0x40);//CGUCON7

    DBG_SFR("\n\r\n\rIIC");
    Test_WriteSFR(0x90,0x31,0x00);//I2CCON
    ...
    Test_WriteSFR(0xD3,0xFF,0x00);//MEMBIST_EN_ID2
    Test_WriteSFR(0xD4,0xFF,0x00);//MEMBIST_FINISH_ID1
    Test_WriteSFR(0xD5,0xFF,0x00);//MEMBIST_FINISH_ID2
    Test_WriteSFR(0xD6,0xFF,0x00);//MEMBIST_FAIL_ID1
    Test_WriteSFR(0xD7,0xFF,0x00);//MEMBIST_FAIL_ID1
    Test_WriteSFR(0xD8,0xFF,0x00);//MEMBIST_ERRMAP_ID1
    Test_WriteSFR(0xD9,0xFF,0x00);//MEMBIST_ERRMAP_ID1
    Test_WriteSFR(0xDD,0xFF,0x00);//MEMBIST_ROMCRCH_ID1
    Test_WriteSFR(0xDE,0xFF,0x00);//MEMBIST_ROMCRCL_ID1
