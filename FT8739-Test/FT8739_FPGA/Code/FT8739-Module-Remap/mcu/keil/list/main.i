...
#line 80 "..\..\src\source\main.c" 
 ...
 printf("\n\rPORRST_CNT:%02x",PORRST_CNT);
 printf("\n\rWDTRST_CNT:%02x",WDTRST_CNT);    
 printf("\n\rEXTRST_CNT:%02x",EXTRST_CNT);
 printf("\n\rLEDRST_CNT:%02x",LCDRST_CNT);
 printf("\n\rinit ok");
 }
