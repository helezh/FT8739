...
/*******************************************************************************
* Name: ParityCheck
* Brief:  used when UART is in 9bit mode
* Input:  a UINT8 data which is going to be loaded to UART_BUFF to send
* Output: none
* Return: BOOLEAN 1:data is odd; 0:data is even
*******************************************************************************/
BOOLEAN ParityCheck(UINT8 x)
{
    UINT8 val = 0;
    while(x)
    {
...
/*******************************************************************************
* Name: CLK_DIV
* Brief:  system clock divesion
* Input:
* Output: None
* Return: Divesion rate
*******************************************************************************/
