...
//-----------------------------------------------------------------------------
/* rom参数 */
#define RV_G_ROM_SPI_DIV            0x00  // 0x00:4分频; 0x01:6分频; 0x02:8分频; 0x03:12分频
#define RV_G_ROM_SYS_CLK            0x00  // 0x00:48M,其它:24M


#define RV_G_ROM_SPI_MODE           0X3B//0X0B:Fast Read Command
                                        //0X3B:Fast Read Dual Output Command
                                        //0XBB:Fast Read Dual I/O Command
                                        
                                         
// pramboot id
#define RV_G_BOOT_ID_HIGH           0x88
#define RV_G_BOOT_ID_LOW            0xA5
...
#define  DAT_COF_PANEL_ENABLE        0x00  //[8]  COF屏幕模式使能 0:不使能;  1:使能
...
#define  rAFE_SCAN_CFG0              ((DAT_AFE_SCAN_TIMES<<3)\                                          
                                     +(DAT_AFE_SCAN_MODE<<0))
...
#define  rAFE_SCAN_CFG1              ((DAT_DOU_SAMPLE_MODE<<9)\                                          
...
#define  rAFE_DUMMY_SCAN_CFG         ((DAT_SCAN_MUX_DUMMY_NUM<<10)\                                          
...
//0x0D  13
#define  DAT_AFE_ANA_GEN_CFG0        0xC1    //[10:0] K1: CA_P1高电平宽度，实际值为配置值加1.
#define  rAFE_ANA_K1_CFG0           (DAT_AFE_ANA_GEN_CFG0<<0)

//0x0E  14
#define  DAT_AFE_ANA_GEN_CFG1        0x2D    //[10:0] K2: CA_P1低电平宽度，实际值为配置值加1.
...
#define  rAFE_ANA_P1_P2_CFG0         (DAT_T7_SX<<0)

//0x13  19                           
#define  DAT_T8_SX                   0x000   //[9:0]  SX/VCOM_OPT T8时间宽度
#define  rAFE_ANA_P1_P2_CFG1         (DAT_T8_SX<<0)

//0x14  20                           
#define  DAT_T7_GIP                  0x000   //[9:0]  GIPH/GIPL T7时间宽度
#define  rAFE_ANA_P1_P2_CFG2         (DAT_T7_GIP<<0)
...
#define  rAFE_ANA_SH_CFG0            (DAT_T10<<0)

//0x1B  27
#define  DAT_T11                     0x21 //0x011  //[9:0] T11 时间宽度
#define  rAFE_ANA_SH_CFG1            (DAT_T11<<0)

//0x1C  28
#define  DAT_T12                     0x001  //[9:0] T12 时间宽度
#define  rAFE_ANA_SH_CFG2            (DAT_T12<<0)
...
#define  rAFE_ANA_ADC_CFG1           ((DAT_T25<<9)\
                                     +(DAT_T21<<0))
...
//0x32  50
#define  DAT_CB_ADJUST_THLD          0x0000 //[15:0] 硬件CB校正阈值，目标值。
#define  rCB_ADJUST_THLD             (DAT_CB_ADJUST_THLD<<0)
...
#define  rANA_STATIC_CFG3            ((DAT_EN_TXSLR<<12)\  
                                     +(DAT_TXSLR<<10)\
                                     +(DAT_VDD5_SEL<<6)\
                                     +(DAT_VREF_TP_SEL<<3)\  
                                     +(DAT_VREF_TP_SEL<<0))   
...
//0x42 66
#define DAT_KEY_SAMPLE_INTERAL_6     0x0  //[10:0]6倍采样间隔: (K1+K2)*2/6
#define  rKEY_SAMPLE_INTERVAL_6      (DAT_KEY_SAMPLE_INTERAL_6<<0)
...
#define  rADC_CFG                    ((DAT_RAWDATA_OFFSET_H<<3)\  
                                     +(DAT_DATA_INV<<2)\
                                     +(DAT_ADC_DUMMY_SHUF<<1)\
                                     +(DAT_ADC_MSB_INV<<0))  
//0x46 70
