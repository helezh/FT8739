...
void Test_SFR()
{
    ...
    DBG_SFR("\n\r\n\rSPI0:");
    Test_WriteSFR(0xA3,0xEF,0x10);//SPI0CON2
    ...
    Test_WriteSFR(0x9E,0x0C,0x20);//RTCCON
    Test_WriteSFR(0xB6,0x06,0x00);//RTCCON1
    
    DBG_SFR("\n\nSystem:");
    Test_WriteSFR(0x98,0xDF,0x80);//SYS_CON
    ...
    Test_WriteSFR(0xDA,0x01,0x00);//dsv_con
    ...
    //Test_WriteSFR(0xDB,0xFF,0x00);//MEMBIST_ROMCRC_ID0
    //Test_WriteSFR(0xDC,0xFF,0x00);//MEMBIST_ROMCRC_ID1    
    //Test_WriteSFR(0xDD,0xFF,0x00);//MEMBIST_ROMCRC_ID2
    //Test_WriteSFR(0xDE,0xFF,0x00);//MEMBIST_ROMCRC_ID3
