...
//暂停停止测试
//#define INT_HOLD         //在定时中断中，暂停计数
//#define INT_STOP         //在定时中断中，停止计数,该stop为串口的stop模式,不是低功耗的stop模式
//#define MAIN_HOLD        //主程序中，直接暂停
#define   RUN_MODE        1 //0:single mode   1:repeat mode

//中断唤醒测试
//#define TEST_IDLE         //在定时中断中，暂停计数
//#define TEST_STANDBY      //在定时中断中，停止计数
//#define TEST_STOP         //主程序中，直接暂停，低功耗的stop模式
