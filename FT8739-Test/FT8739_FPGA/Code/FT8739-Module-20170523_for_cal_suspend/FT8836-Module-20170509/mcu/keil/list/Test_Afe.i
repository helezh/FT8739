...
#line 1 "..\..\src\source\task\Test_Afe.c" 
...
#line 21 "..\..\src\source\task\Test_Afe.c" 
...
#line 22 "..\..\src\source\task\Test_Afe.c" 
...
#line 17 "..\..\src\include\Drv\Drv_XSI.h" 
...
#line 67 "..\..\src\include\Drv\Drv_XSI.h" 
 
#line 23 "..\..\src\source\task\Test_Afe.c" 
...
#line 99 "D:\software\Keil\C251\INC\string.h" 
 ...
 #pragma RESTORE
#line 24 "..\..\src\source\task\Test_Afe.c" 
 ...
 ST_AsmRegisters * near pAsmRegs = (volatile ST_AsmRegisters *)0xB100;
 UINT16	near  g_ucOrderBuf[(324)<<1];	   
 ...
 XSI0RegValue = Drv_XsiReadReg(pXSI0Regs,ID_AFE_BASE + 0x05,0);
 XSI1RegValue = Drv_XsiReadReg(pXSI1Regs,ID_AFE_BASE + 0x05,0);
 ...
 else if(RamSelect == AREA_BASE_ORDER)  
 {
 XSI0RegValue|= (2<<3);  
 XSI1RegValue|= (2<<3);  
 }
 ...
 Drv_XsiWriteReg(pXSI0Regs,ID_AFE_BASE + 0x05, XSI0RegValue,0);
 Drv_XsiWriteReg(pXSI1Regs,ID_AFE_BASE + 0x05, XSI1RegValue,0);   
 }
 ...
 {
 UINT16 near i;
 UINT16 near aus_tabbuf[176];
 
 memset(aus_tabbuf, 0, 176*2);
 ...
 aus_tabbuf[10 + 0] = 0x0100;       
 aus_tabbuf[10 + 1] = 0x0100;      
 aus_tabbuf[10 + 2] = 0x0100;
 aus_tabbuf[10 + 3] = 0x0100;
 
 Drv_XsiWrite(pXSI0Regs,256+ucTabID*176+10,&aus_tabbuf[10],176,0);
 Drv_XsiWrite(pXSI1Regs,256+ucTabID*176+10,&aus_tabbuf[10],176,0);
 }
 ...
 for (i = 0; i < len; i++)
 {
 Buf[i] = g_ucOrderBuf[i];   
 }
 Drv_XsiWrite(pXSI0Regs,256,Buf,len,0);
 Drv_XsiWrite(pXSI1Regs,256,Buf,len,0);		 
 ...
 XSICKEN = 1;
 usReg0 = (15<<1)|(14<<1)|(0<<11)|(0<<7)|(0<<5)|(0<<3)|(1<<2)|(1<<1)|(1<<0);   
 ...
 Drv_XsiWriteReg(pXSI0Regs,256+0,usReg0,0);
 Drv_XsiWriteReg(pXSI1Regs,256+0,usReg0,0);
 Drv_XsiWriteReg(pXSI0Regs,256+1,usReg1,0); 
 Drv_XsiWriteReg(pXSI1Regs,256+1,usReg1,0);
 Drv_XsiWriteReg(pXSI0Regs,256+2,usReg2,0); 
 Drv_XsiWriteReg(pXSI1Regs,256+2,usReg2,0);
 Drv_XsiWriteReg(pXSI0Regs,256+3,usReg3,0);
 Drv_XsiWriteReg(pXSI1Regs,256+3,usReg3,0);
 Drv_XsiWriteReg(pXSI0Regs,256+4,usReg4,0);
 Drv_XsiWriteReg(pXSI1Regs,256+4,usReg4,0);
 Drv_XsiWriteReg(pXSI0Regs,256+5,usReg5,0); 
 Drv_XsiWriteReg(pXSI1Regs,256+5,usReg5,0);
 Drv_XsiWriteReg(pXSI0Regs,256+6,usReg6,0); 
 Drv_XsiWriteReg(pXSI1Regs,256+6,usReg6,0);
 Drv_XsiWriteReg(pXSI0Regs,256+7,usReg7,0); 
 Drv_XsiWriteReg(pXSI1Regs,256+7,usReg7,0);
 Drv_XsiWriteReg(pXSI0Regs,256+8,usReg8,0); 
 Drv_XsiWriteReg(pXSI1Regs,256+8,usReg8,0);
 Drv_XsiWriteReg(pXSI0Regs,256+9,usReg9,0); 
 Drv_XsiWriteReg(pXSI1Regs,256+9,usReg9,0);
 
 for(i = 0; i < 10; i++)
 {
 usReg = Drv_XsiReadReg(pXSI0Regs,256+i,0);
 printf("\n%04x",usReg);
 }
 ...
 void DrvAsmInterEnable0(UINT16 usInterMode)
 {
 pAsmRegs->usAsmIntEn0|=(1<<usInterMode);  
 }
 
 void DrvAsmInterEnable1(UINT16 usInterMode)
 {
 pAsmRegs->usAsmIntEn1|=(1<<usInterMode);  
 }
 ...
 pAsmRegs->usAsmScanCfg0|=(ucScanMul<<0);    
 
 
 pAsmRegs->usAsmTpFrameCfg0 = ((ucF1TabId<<14)      
 +(ucBusyId1<<8)    
 +(ucF0TabId<<6)     
 +(ucBusyId0<<0));  
 
 
 pAsmRegs->usAsmTpFrameCfg1 = ((ucF3TabId<<14)      
 +(ucBusyId3<<8)    
 +(ucF2TabId<<6)     
 +(ucBusyId2<<0));  
 ...
 UINT16 near usConfigValue;
 static near FristStart = 1;
 ...
 usConfigValue = 0xFF;
 Drv_XsiWriteReg(pXSI0Regs, Addr_AFE_SX_P1_P2_CFG, usConfigValue, 0);  
 Drv_XsiWriteReg(pXSI1Regs, Addr_AFE_SX_P1_P2_CFG, usConfigValue, 0);
 
 DrvAsmInterEnable0(BIT_LCD_ARAM_RDY_EN0);
 
 DrvLoadTabMultiple(1,6,0,0,0,0);     
