...
SBIT SPI1_CURR_MODE         = SPI1CON4^3; /*spi master/slave mode状态位.0:目前为master mode.1:目前未slave mode */
...
SBIT XSI_STA                = FT_EN_REG^1;     /* anacon[3] xsi clk swtich result.1:AFE can control xsi;0:MCU can control xsi*/
...
#define PRAM_BASE_ADDR        0xFEE800
#define FW_CFG_ADDR           0x780  //configured area 54KB-128
#define FLASH_APP_INFO        0x100
...
#define ADDR_APP_LEN_H        (FLASH_APP_INFO + 0)
#define ADDR_APP_LEN_L        (FLASH_APP_INFO + 1)
#define ADDR_ECC              (FLASH_APP_INFO + 4)

#define ARAM_ADDR16(n)        (*((UINT16 *)(0xA000 + n)))
#define ARAM_ADDR8(n)         (*((UINT8 *)(0xA000 + n)))


#define PRAM_ADDR8(n)         (*((UINT8 far *)((UINT32)0xFEE800 + n)))
#define PRAM1_ADDR8(n)        (*((UINT8 far *)((UINT32)0xFF0000 + n)))//64K
...
#define PRAM1_ADDR16(n)       (*((UINT16 far *)((UINT32)0xFF0000 + n)))//64K

#define PROM_ADDR16(n)        (*((UINT16 far *)((UINT32)0xFD0000 + n)))
#define DRAM_ADDR16(n)        (*((UINT16 *)((UINT32)0x0000 + n)))

#define LCD_REG_ADDR8(n) (*((UINT8 far *)(0x020000 + n)))  //地址空间02:0000，地址为16bit
