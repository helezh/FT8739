...
#line 1 "..\..\src\source\driver\Drv_XBUS.c" 
...
#line 17 "\work space\FT8836 SVN\FT8836-Module-20170317\src\include\Drv\Drv_XBUS.h" 
...
#line 53 "\work space\FT8836 SVN\FT8836-Module-20170317\src\include\Drv\Drv_XBUS.h" 
...
#line 17 "..\..\src\source\driver\Drv_XBUS.c" 
...
#line 18 "..\..\src\source\driver\Drv_XBUS.c" 
#line 18 "..\..\src\source\driver\Drv_XBUS.c" 
 ...
 ST_LcdWrapRegisters *near pLcdWrapRegs = (volatile ST_LcdWrapRegisters *)0xBC00; 
 ...
 while(((pLcdWrapRegs->lcd_regfile_ctrl) & (((UINT16)1<<(1)))) == 0);    
 Dummy = (*((UINT8 far *)(0x020000 + usaddr)));     
 while(((pLcdWrapRegs->lcd_regfile_ctrl) & (((UINT16)1<<(0)))) == 0);    
 return (UINT16)((pLcdWrapRegs->rdata_lo_byte << 8) + (pLcdWrapRegs->rdata_ho_byte & 0x00ff));  
 }
 ...
 {
 while(((pLcdWrapRegs->lcd_regfile_ctrl) & (((UINT16)1<<(1)))) == 0);  
 (*((UINT8 far *)(0x020000 + usaddr))) = usdata;
 
 }
 
 
 
#line 100 "..\..\src\source\driver\Drv_XBUS.c" 
...
#line 112 "..\..\src\source\driver\Drv_XBUS.c" 
