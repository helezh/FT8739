...
******************************************************************************/
#if  _TEST_PRAM_EN
void test_pram(UINT8 far *psrc,UINT32 len,UINT8 test_cnt)//54byte
{
    UINT8 far *ptr8=0;    
    UINT8  temp=0x5a;
    UINT8  k=0;
